...
```
$ docker image tag blog keithchenon/blog
$ docker push keithchenon/blog
$ docker image tag gateway keithchenon/gateway
$ docker push keithchenon/gateway
$ docker image tag store keithchenon/store
$ docker push keithchenon/store
```
